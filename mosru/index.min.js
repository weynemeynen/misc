...
modules.define(
    'jquery', ['loader_type_js', 'jquery__config'],
...
modules.define(
    'events', ['identify', 'inherit', 'functions'],
    ...
    var app = {
        ...
        setUpListeners: function() {
            var modal = $('#modal-main'),
                ...
                link_opener = $('.link_opener').click(function(e) {
                    e.preventDefault();
                    modal.modal('hide');
                });
            $('#your-data').on('submit', app.submitForm);
            $('#your-data').on('keydown click', '.required', app.removeError);
        ...
        validateForm: function(form) {
            ...
            $.each(inputs, function(index, val) {
                var input = $(this),
                    val = input.val(), // значение поля value
                ...
                if (val.length === 0) {
                    ...
                    valid = false; // если ошибка то false
...
var photoInputButton = document.getElementById('photoInputButton'),
    photoInput = document.getElementById('photoInput'),
    errors = document.getElementById('errors');
errors.style.color = 'maroon';

photoInputButton.addEventListener('click', function(e) {
    photoInput.click();
});

photoInput.addEventListener('change', function(e) {
    var file = e.target.files[0],
        important_know__button_text = document.querySelector('.important-know__button-text'),
        note = document.createElement('div'),
        valid = true;

    if (file.type != "image/jpeg") {
        textNote = document.createTextNode('картинка должна быть формата jpg');
        note.appendChild(textNote);
        errors.insertAdjacentElement('beforeend', note);

        return;
    }

    if (file.size > 102400) {
        textNote = document.createTextNode('допустимый размер: не более 100 КБ');
        note.appendChild(textNote);
        errors.insertAdjacentElement('beforeend', note);
        return;
    }
    ...
    errors.remove();
    readImage(file);
    important_know__button_text.remove();
});

;
(function() {
    var eye = document.querySelector('.input-group-addon'),
        eyeIcon = eye.querySelector('.glyphicon'),
